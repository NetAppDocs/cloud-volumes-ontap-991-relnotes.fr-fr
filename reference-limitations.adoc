...
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["Découvrez comment sauvegarder et restaurer les données ONTAP avec Cloud Backup"^].
