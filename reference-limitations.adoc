...
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html["Découvrez comment sauvegarder et restaurer les données ONTAP avec Cloud Backup"^].
